...
const PhoneSvg = () => <S><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></S>;
      ...
      <div className="container-cravio">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: '40px', alignItems: 'start' }}>
          ...
          <div>
            ...
            {[
              { icon: <MailSvg />, label: 'Email', value: 'hello@cravio.app' },
              { icon: <PhoneSvg />, label: 'Phone', value: '+91 98765 43210' },
              { icon: <PinSvg />, label: 'Address', value: 'Bengaluru, Karnataka, India' },
              { icon: <ClockSvg />, label: 'Support Hours', value: 'Mon–Sun, 9AM–9PM' },
            ].map(item => (
          ...
          <div style={{ background: 'white', borderRadius: '16px', border: '1px solid var(--border)', padding: '32px' }}>
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="form-cravio" style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                ...
                <button type="submit" className="btn-olive" style={{ padding: '12px', borderRadius: '9px', fontSize: '0.98rem' }}>
                  Send Message →
                </button>
              </form>
            )}
