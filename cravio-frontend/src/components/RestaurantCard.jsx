...
export default function RestaurantCard({ restaurant }) {
  ...
  const displayImage  = image ? (image.startsWith('http') ? image : `http://localhost:8000${image}`) : (mock.image || 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=600&q=80');
